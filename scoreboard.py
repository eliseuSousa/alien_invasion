...
class Scoreboard():
    ...
    def __init__(self, ai_settings, screen, stats):
        ...
        # Configurações de fonte para a informação de pontuação
    ...
    def prep_high_score(self):
        ...
        # Centraliza a pontyuação máxima na parte superior da tela
        self.high_score_rect = self.high_score_image.get_rect()
        self.high_score_rect.centerx = self.screen_rect.centerx
        self.high_score_rect.top = self.screen_rect.top
    
    def prep_level(self):
        """Transforma o nível em uma imagem redenrizada."""
        self.level_image = self.font.render("Level: "+str(self.stats.level), True, self.text_color, self.ai_settings.bg_color)
        # Posicionar o nível no meio
        self.level_rect = self.level_image.get_rect()
        self.level_rect.right = self.score_rect.right
        self.level_rect.top = self.score_rect.bottom + 10

    def prep_ships(self):
        """Mostrar a quantidade de espaçonaves que restam."""
        self.ships = Group()
